...
<div class="layui-card-header" style="font-size: 30px">添加虫害</div>
    ...
    <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-upload" style="padding-left: 200px">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-upload" style="padding-left: 200px">
                <img class="layui-upload-img" id="test-upload-normal-img1" style="width: 100px;height: 100px">
                <p id="test-upload-demoText1"></p><br/>
                <button type="button" class="layui-btn" id="test-upload-normal1">上传图片</button>
            </div>
        </div>
    </div>
